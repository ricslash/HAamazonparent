...
export REAUTH_INTERVAL="${REAUTH_INTERVAL:-72000}"
export HEALTH_CHECK_INTERVAL="${HEALTH_CHECK_INTERVAL:-14400}"
export REAUTH_MAX_RETRIES="${REAUTH_MAX_RETRIES:-3}"
...
echo "[INFO]   - Reauth Interval: ${REAUTH_INTERVAL}s"
echo "[INFO]   - Health Check Interval: ${HEALTH_CHECK_INTERVAL}s"
echo "[INFO]   - Reauth Max Retries: ${REAUTH_MAX_RETRIES}"
